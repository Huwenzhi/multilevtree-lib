...
public class BackBean {
    ...
    private List<BackListsBean> backLists;
    ...
    public List<BackListsBean> getBackLists() {
        return backLists;
    }

    public void setBackLists(List<BackListsBean> backLists) {
        this.backLists = backLists;
    }

    public static class BackListsBean {
        /**
         * name : null
         * pid : 1
         * id : null
