package com.hu_sir.multilevtree.utils;
 ...
 *
 * @ProjectName: TreeHelper.java
 * @Package: com.hu_sir.multilevtree.utils
 * @ClassName: TreeHelper
 * @Description: TODO
 * @Author: Hu_Sir
 * @CreateDate: 2019/6/5--16:39
 * @UpdateUser: ?
 * @UpdateDate: 2019/6/5--16:39
 * @UpdateRemark: todo
 */
public class TreeHelper {
     ...
     * @return
     */
    public static List<Node> filterVisibleNodeshowOther(List<Node> nodes) {
        List<Node> result = new ArrayList<Node>();
        for (Node node : nodes) {
            // 如果为跟节点，或者上层目录为展开状态
                if (node.isShow()) {
